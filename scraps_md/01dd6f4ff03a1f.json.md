...
// , @as([]const builtin.Type.UnionField, .{ .{.name = "Type", .type = void, .alignment = 0}, .{.name = "Void", .type = void, .alignment = 0}, .{.name = "Bool", .type = void, .alignment = 0}, .{.name = "NoReturn", .type = void, .alignment = 0}, .{.name = "Int", .type = builtin.Type.Int, .alignment = 2}, .{.name = "Float", .type = builtin.Type.Float, .alignment = 2}, .{.name = "Pointer", .type = builtin.Type.Pointer, .alignment = 8}, .{.name = "Array", .type = builtin.Type.Array, .alignment = 8}, .{.name = "Struct", .type = builtin.Type.Struct, .alignment = 8}, .{.name = "ComptimeFloat", .type = void, .alignment = 0}, .{.name = "ComptimeInt", .type = void, .alignment = 0}, .{.name = "Undefined", .type = void, .alignment = 0}, .{.name = "Null", .type = void, .alignment = 0}, .{.name = "Optional", .type = builtin.Type.Optional, .alignment = 0}, .{.name = "ErrorUnion", .type = builtin.Type.ErrorUnion, .alignment = 0}, .{.name = "ErrorSet", .type = ?[]const builtin.Type.Error, .alignment = 8}, .{.name = "Enum", .type = builtin.Type.Enum, .alignment = 8}, .{.name = "Union", .type = builtin.Type.Union, .alignment = 8}, .{.name = "Fn", .type = builtin.Type.Fn, .alignment = 1}, .{.name = "Opaque", .type = builtin.Type.Opaque, .alignment = 8}, .{.name = "Frame", .type = builtin.Type.Frame, .alignment = 8}, .{.name = "AnyFrame", .type = builtin.Type.AnyFrame, .alignment = 0}, .{.name = "Vector", .type = builtin.Type.Vector, .alignment = 0}, .{.name = "EnumLiteral", .type = void, .alignment = 0} })
